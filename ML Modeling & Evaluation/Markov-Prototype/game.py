...
class Game:
    ...
    def __init__(self, args):
        ...
        self._driver = webdriver.Chrome(executable_path = args.chrome_driver_path, options=chrome_options)
    ...
    def get_playing(self):
        ...
        """
        self._driver.execute_script("console.log(Runner.instance_.paused)")

        # send a Javascript signal to Chrome
        isPlaying = self._driver.execute_script("return Runner.instance_.paused")
        return isPlaying
